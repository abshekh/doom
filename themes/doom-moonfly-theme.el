...
;; Homepage: https://github.com/stackmystack/doom-moonfly-theme/blob/master/doom-moonfly-theme.el
...
(def-doom-theme doom-moonfly
  ...
  (((line-number &override) :foreground base2)
   ...
   (lsp-face-highlight-read          :foreground fg :background (doom-lighten base1 0.05))
   (lsp-face-highlight-textual       :foreground fg :background (doom-lighten base1 0.05))
   (lsp-face-highlight-write         :foreground fg :background (doom-lighten base1 0.05))
   (lsp-ui-peek-highlight            :foreground fg :background (doom-lighten base1 0.05))
